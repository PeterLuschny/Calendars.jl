...
function isLeapYearIslamic(year::Int64)
...
function DayNumberValidIslamic(year::Int64, month::Int64, day::Int64)
...
function DayNumberIslamic(year::Int64, month::Int64, day::Int64)  
